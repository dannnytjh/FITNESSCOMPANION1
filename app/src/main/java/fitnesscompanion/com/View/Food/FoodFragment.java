...
public class FoodFragment extends Fragment {
    ...
    @BindView(R.id.menu_food) FloatingActionMenu menu_food;
    //@BindView(R.id.fabAdd) FloatingActionButton fabAdd;
    @BindView(R.id.fabUpload) FloatingActionButton fabUpload;
    @BindView(R.id.fabBarcode) FloatingActionButton fabBarcode;
    @BindView(R.id.fabSearch) FloatingActionButton fabSearch;
    @BindView(R.id.progressBar) ProgressBar progressBar;
    @BindView(R.id.txtDate) TextView txtDate;
    @BindView(R.id.txtIntake) TextView txtIntake;
    @BindView(R.id.txtRemaining) TextView txtRemaining;
    @BindView(R.id.btnBack) ImageButton btnBack;
    @BindView(R.id.btnGo) ImageButton btnGo;
    @BindView(R.id.expandedListFood) ExpandableListView expandedListFood;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        foodRequest = new FoodRequest(context);
        user = userDB.getData();
